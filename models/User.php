...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            ['username', 'match', 'pattern' => '/^[a-zA-Z0-9_]+$/', 'message' => Yii::t('app', 'Только буквы, цифры и _'), 'on' => 'register'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'email_verified_at' => Yii::t('app', 'Email подтверждён'),
            ...
            'is_private' => Yii::t('app', 'Приватный профиль'),
            'created_at' => Yii::t('app', 'Создан'),
            'updated_at' => Yii::t('app', 'Обновлён'),
            'avatarFile' => Yii::t('app', 'Файл аватара'),
